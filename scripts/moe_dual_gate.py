...
if __name__ == '__main__':
    ...
    for experiment_id, params in experiments.items():
        ...
        if WEIGHT_TRIGGERS and DATASET in ['MaSaC', 'MaSaC_translated']:
            file_path = f'results/{DATASET}/weighted_moe_model_{GATE_TYPE}_dual_gate_{NUM_EXPERTS}_{EXPERT_TYPE}_experts_{TOP_K}_active_{LEARNING_RATE}_lr_{NUM_EPOCHS}_epochs.txt'
        else:
